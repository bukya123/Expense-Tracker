...
import com.example.demo.DTOs.responses.SavedTransactionResponseDto;
...
import com.example.demo.Repositories.SavedTransactionRepository;
...
@Service
@Slf4j
public class SavedTransactionServiceImp implements SavedTransactionService {
    @Autowired
