...
function Navbar(){
   ...
   return (
        <div className="h-[70px]  bg-amber-600 text-white z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
                <Link to="/" className="flex items-center text-2xl font-bold">
                    <GrMoney className="mr-2 text-3xl"/>
                    <span className="font-[Poppins]">ExpenseTracker</span>
                </Link>
            ...
            navbarOpen ? "h-fit sm:pb-0 pb-5" : "h-0 overflow-hidden"
                ...
                <li className="font-medium transition-all duration-150">
                   <Link className={`${
                    path === "/Expense" ? "text-white font-semibold" : "text-gray-200"
                   }`}
                    to="/Expense">
                        Expense
                   </Link> 
